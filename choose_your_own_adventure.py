...
answer = input(
    "You are on a dirt road, it has to an end and you can go left or right. which would you like to go? ")
...
if answer == "left":
    ...
    if answer == "back":
        ...
        answer = input("You cross the bridge and meet a stranger. Do you talk to the them (yes/no)? ")
